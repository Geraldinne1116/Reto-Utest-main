...
public class UtestStepDefinition {
    ...
    public void geraldinneDeseaRegistrarseEnLaPlataformaUtest() throws Exception {
        theActorCalled("Geraldinne").wasAbleTo(AbrirPaginaUtest.laPagina());
    }
    ...
    public void elRegistroSeCompletaCuandoApareceElMensajeDeBienvenida(List<UtestDatos> datos) {
